 ...
 * 具体装饰器类 - 奶泡装饰器
 * 
 * 装饰器模式中的具体装饰器角色，继承抽象装饰器，添加奶泡配料的功能。
 * 
 * 设计特点：
 ...
 * 
 * 工作原理：
 * 1. cost() 方法：先调用 super.cost() 获取被装饰对象的价格，再加上奶泡的价格
 * 2. getDescription() 方法：先调用 super.getDescription() 获取被装饰对象的描述，再追加奶泡的描述
 */
public class WhipDecorator extends CoffeeDecorator {
     ...
     */
    private static final double WHIP_PRICE = 2.5;
