 ...
 * 具体装饰器类 - 香草装饰器
 * 
 * 装饰器模式中的具体装饰器角色，继承抽象装饰器，添加香草配料的功能。
 * 
 * 设计特点：
 ...
 * 
 * 工作原理：
 * 1. cost() 方法：先调用 super.cost() 获取被装饰对象的价格，再加上香草的价格
 * 2. getDescription() 方法：先调用 super.getDescription() 获取被装饰对象的描述，再追加香草的描述
 */
public class VanillaDecorator extends CoffeeDecorator {
     ...
     */
    private static final double VANILLA_PRICE = 3.0;
    ...
    @Override
    public double cost() {
        return super.cost() + VANILLA_PRICE;
    }
